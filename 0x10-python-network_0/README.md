...
- This project is about using `curl` in Bash scripts to send various types
of HTTP headers.
...
## Tasks :page_with_curl:
 Mark: The `curl` is a command-line tool used to transfer data to or from a server, using a variety of protocols. It is designed to work without user interaction and can be used to automate the testing of websites, web services, and APIs.
